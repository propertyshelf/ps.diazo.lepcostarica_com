# -*- coding: utf-8 -*-
"""Test Setup of ps.diazo.lepcostarica_com."""
...
# local imports
from ps.diazo.lepcostarica_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++ps.diazo.lepcostarica_com/main.css',
]

JS = [
    '++resource++ps.diazo.lepcostarica_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.diazo.lepcostarica_com."""

    layer = testing.PS_DIAZO_LEPCOSTARICA_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('IPsDiazoLepcostaricaComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('IPsDiazoLepcostaricaComLayer', layers)
